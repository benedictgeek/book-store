    ...
    @endif  
          ...
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                <input type="text" value="{{ $productDetails->product_name }}" name="product_name" id="product_name">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Product Code</label>
                <div class="controls">
                    <input type="text" value="{{ $productDetails->product_code }}" name="product_code" id="product_code">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Product Color</label>
                <div class="controls">
                    <input type="text" value="{{ $productDetails->product_color }}"  name="product_color" id="product_color">
                </div>
            </div>
              <div class="control-group">
                <label class="control-label">Description</label>
                <div class="controls">
                <textarea type="text" value="{{ $productDetails->description }}" name="description" id="description"></textarea>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Material & Care</label>
                <div class="controls">
                <textarea type="text" value="{{ $productDetails->care }}" name="care" id="care"></textarea>
                </div>
              </div>
              <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <img src="{{asset('images/backend_img/products/small/'.$productDetails->image)}}" style="width: 40px"> | <a href="{{ url('/admin/del-product-image/'.$productDetails->id)}}">Delete</a>
                    @endif
                </div>
            </div>
            <div class="control-group">
